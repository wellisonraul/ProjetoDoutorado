    ...
    create table j3_address (
        ...
        sort_code varchar2(10 char) null,
        tmodel_key varchar2(255 char) null,
        use_type varchar2(255 char) null,
    ...
    create table j3_address_line (
        id number(19,0) identity not null,
        key_name varchar2(255 char) null,
        key_value varchar2(255 char) null,
    ...
    create table j3_auth_token (
        ...
        ipaddress varchar2(51 char) null,
    ...
    create table j3_binding_descr (
        ...
        lang_code varchar2(26 char) null,
        entity_key varchar2(255 char) not null,
        primary key (id)
    );

    create table j3_binding_template (
        access_point_type varchar2(255 char) null,
        access_point_url long null,
        hosting_redirector varchar2(255 char) null,
        entity_key varchar2(255 char) not null,
    ...
    create table j3_business_identifier (
        ...
        tmodel_key_ref varchar2(255 char) null,
        entity_key varchar2(255 char) not null,
        primary key (id)
    );
    ...
    create table j3_canonicalization_method (
        id number(19,0) identity not null,
        algorithm varchar2(255 char) null,
        primary key (id)
    );
    ...
    create table j3_chg_record (
        id number(19,0) not null,
        change_contents blob null,
        entity_key varchar2(255 char) null,
        node_id varchar2(255 char) null,
        orginating_usn number(19,0) null,
        record_type number(10,0) null,
        primary key (id)
    );

    create table j3_chg_replconf (
        serialnumb number(19,0) not null,
        maxgettime number(19,2) null,
        maxsynctime number(19,2) null,
        configupdate varchar2(255 char) null,
        communicationGraph_j3_id number(19,0) null,
        contact_id number(19,0) null,
    ...
    create table j3_client_subscriptioninfo (
        ...
        fromClerk_clerk_name varchar2(255 char) null,
        toClerk_clerk_name varchar2(255 char) null,
    ...
    create table j3_ctrl_msg (
        id number(19,0) not null,
        j3_message varchar2(255 char) null,
        primary key (id)
    );
    ...
    create table j3_edge (
        id number(19,0) identity not null,
        communicationGraph_j3_id number(19,0) null,
        messageReceiver_name varchar2(255 char) null,
        messageSender_name varchar2(255 char) null,
        primary key (id)
    );
    ...
    create table j3_key_data_value (
        id number(19,0) identity not null,
        key_data_name varchar2(255 char) null,
        key_data_type varchar2(255 char) null,
        key_data_value blob null,
        key_data_value_string clob null,
        key_data_value_key number(19,0) null,
        key_info_key number(19,0) null,
        primary key (id)
    );
    ...
    create table j3_keyed_reference (
        ...
        key_value varchar2(255 char) not null,
        tmodel_key_ref varchar2(255 char) null,
        category_bag_id number(19,0) null,
        keyed_reference_group_id number(19,0) null,
        primary key (id)
    );
    ...
    create table j3_node (
        ...
        factory_initial varchar2(255 char) null,
        factory_naming_provider varchar2(255 char) null,
        factory_url_pkgs varchar2(255 char) null,
        inquiry_url varchar2(255 char) not null,
        juddi_api_url varchar2(255 char) null,
        proxy_transport varchar2(255 char) not null,
        publish_url varchar2(255 char) not null,
        replication_url varchar2(255 char) null,
    ...
    create table j3_object_type (
        id number(19,0) identity not null,
        encoding varchar2(255 char) null,
        mime_type varchar2(255 char) null,
        xml_id varchar2(255 char) null,
    ...
    create table j3_operator (
        ...
        operator_status number(10,0) null,
        replicationurl varchar2(255 char) null,
    ...
    create table j3_overview_doc (
        ...
        overview_url_use_type varchar2(255 char) null,
        entity_key varchar2(255 char) null,
        tomodel_instance_info_id number(19,0) null,
        primary key (id)
    );
    ...
    create table j3_overview_doc_descr (
        ...
        lang_code varchar2(26 char) null,
        overview_doc_id number(19,0) null,
        primary key (id)
    );
    ...
    create table j3_publisher (
        ...
        is_admin number(1,0) null,
        is_enabled number(1,0) null,
        max_bindings_per_service number(10,0) null,
        max_businesses number(10,0) null,
        max_services_per_business number(10,0) null,
        max_tmodels number(10,0) null,
    ...
    create table j3_reference (
        id number(19,0) identity not null,
        digest_method varchar2(255 char) null,
        digest_value blob null,
        type varchar2(255 char) null,
        uri varchar2(255 char) null,
        xml_id varchar2(255 char) null,
    ...
    create table j3_signature (
        id number(19,0) identity not null,
        xml_id varchar2(255 char) null,
        binding_template_key varchar2(255 char) null,
        business_key varchar2(255 char) null,
        business_service_key varchar2(255 char) null,
        key_info number(19,0) not null,
        publisher_key varchar2(255 char) null,
        repl_config_key number(19,0) null,
    ...
    create table j3_signature_transform (
        id number(19,0) identity not null,
        transform varchar2(255 char) null,
    ...
    create table j3_subscription (
        subscription_key varchar2(255 char) not null,
        authorized_name varchar2(255 char) not null,
        binding_key varchar2(255 char) null,
        brief number(1,0) null,
        create_date timestamp not null,
        expires_after timestamp null,
        last_notified timestamp null,
        max_entities number(10,0) null,
        notification_interval varchar2(255 char) null,
    ...
    create table j3_subscription_chunk_token (
        ...
        end_point timestamp null,
        expires_after timestamp not null,
        start_point timestamp null,
        subscription_key varchar2(255 char) not null,
